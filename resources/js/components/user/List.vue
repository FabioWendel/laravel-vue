  ...
  <div class="row">
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center">
        <h4 class="d-none d-md-inline mb-3">Usuários</h4>
        <form @submit.prevent="searchUsers">
          <div style="width: 25rem">
            <div class="input-group mb-3">
              <input type="search" v-model="searchQuery" class="form-control form-control-sm"
                placeholder="Pesquisar Usuário" aria-label="Pesquisar Usuário" aria-describedby="button-addon2">
        ...
        <router-link :to="{ name: 'userAdd' }" class="btn btn-outline-dark btn-sm mb-3">
            ...
            <table class="table table-hover">
              ...
              <tbody v-if="users.length">
                <tr v-for="(user, key) in users" :key="key">
                  ...
                  <td>{{ user.email }}</td>
                  <td style="width:8rem">
                    <router-link :to="{ name: 'userEdit', params: { id: user.id } }" class="btn btn-success btn-sm"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Tem certeza de que deseja excluir {{ userName }}?
          </div>
...
const confirmDelete = async () => {
  try {
    loading.value = true;
    await axios.delete(`/api/users/${selectedUserId.value}`);
